...
export default function BookMentorshipPopupPage() {
  return (
    <div className="scr-book-mentorship-popup bg-surface text-on-surface font-body-md selection:bg-primary-container selection:text-on-primary-container">
      {/* Top Navigation Bar */}
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8 hidden" id="mentorship-modal">
        <div className="absolute inset-0 bg-black/40 backdrop-blur-md"></div>
        {" "}
        <div className="relative w-full max-w-4xl bg-surface-container-lowest rounded-xl shadow-lg overflow-hidden flex flex-col md:flex-row animate-fade-in">
          <button className="absolute top-4 right-4 z-10 text-on-surface-variant hover:text-primary transition-colors">
            <span className="material-symbols-outlined text-3xl">close</span>
          </button>
          {" "}
          <div className="w-full md:w-2/5 bg-surface-container p-8 flex flex-col">
            <h2 className="font-display-md text-[28px] text-on-surface mb-8 tracking-tight">Book Your Mentorship</h2>
            {" "}
            <div className="space-y-6">
              <div>
                <span className="font-label-caps text-primary block mb-4">Select a Mentor</span>
                {" "}
                <div className="flex items-center gap-4">
                  <div className="w-20 h-20 rounded-full overflow-hidden border-2 border-primary/20">
                    <img alt="Chi - Lead Mentor" className="w-full h-full object-cover" src="/stitch/img-054.jpg" />
                  </div>
                  {" "}
                  <div>
                    <p className="font-headline-lg text-xl">Chi</p>
                    {" "}
                    <p className="text-body-sm text-outline">Founder & Lead Strategist</p>
                  </div>
                </div>
                {" "}
                <p className="mt-4 text-body-sm text-on-surface-variant leading-relaxed">
                  With over a decade in global hair sourcing and luxury branding, Chi provides actionable insights to scale your boutique to 7-figures.
                </p>
              </div>
              {" "}
              <div className="pt-6 border-t border-outline-variant/30">
                <span className="font-label-caps text-primary block mb-2">Mentorship Details</span>
                {" "}
                <p className="font-body-md font-bold text-on-surface">1-on-1 Strategic Growth</p>
                {" "}
                <p className="text-body-sm text-outline">60-minute intensive session</p>
              </div>
            </div>
          </div>
          {" "}
          <div className="w-full md:w-3/5 p-8 flex flex-col">
            <span className="font-label-caps text-primary block mb-4">Select Date & Time</span>
            {" "}
            <div className="flex-1 bg-surface-container-low rounded-lg p-4 border border-outline-variant/20 mb-6">
              ...
              {" "}
              <div className="grid grid-cols-7 gap-2 text-center text-[12px] font-label-caps mb-2">
                <span>S</span>
                <span>M</span>
                <span>T</span>
                <span>W</span>
              ...
              <div className="grid grid-cols-7 gap-2">
                <div className="py-2 text-outline/30">29</div>
                <div className="py-2 text-outline/30">30</div>
                {" "}
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">1</div>
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">2</div>
                {" "}
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">3</div>
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">4</div>
                {" "}
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">5</div>
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">6</div>
                {" "}
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">7</div>
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">8</div>
                {" "}
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">9</div>
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">10</div>
                {" "}
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">11</div>
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">12</div>
                {" "}
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">13</div>
                <div className="py-2 bg-primary text-on-primary rounded-sm">14</div>
                {" "}
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">15</div>
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">16</div>
                {" "}
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">17</div>
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">18</div>
                {" "}
                <div className="py-2 hover:bg-primary/10 cursor-pointer rounded-sm">19</div>
              </div>
              {" "}
              <div className="mt-6">
                <span className="font-label-caps text-[10px] text-outline block mb-3">Available Slots</span>
                {" "}
                <div className="flex flex-wrap gap-2">
                  <button className="px-4 py-2 border border-outline-variant/50 rounded-sm text-sm hover:border-primary hover:text-primary transition-all">
                    09:00 AM
                  </button>
                  {" "}
                  <button className="px-4 py-2 border border-primary bg-primary/5 text-primary rounded-sm text-sm">11:30 AM</button>
                  {" "}
                  <button className="px-4 py-2 border border-outline-variant/50 rounded-sm text-sm hover:border-primary hover:text-primary transition-all">
                    02:00 PM
                  </button>
            ...
            {" "}
            <button className="w-full bg-primary text-on-primary py-4 font-label-caps tracking-widest hover:opacity-90 transition-opacity shadow-lg">
              Confirm Booking
            </button>
          </div>
        </div>
