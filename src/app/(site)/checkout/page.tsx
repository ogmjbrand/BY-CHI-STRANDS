      ...
      <div className="md:hidden scr-mobile-luxury-checkout bg-background text-on-surface font-body-md selection:bg-primary-container selection:text-on-primary-container overflow-x-hidden">
        ...
        <main className="pt-24 pb-32 px-margin-mobile max-w-lg mx-auto">
          ...
          <section className="space-y-12 mb-16">
            <div>
              ...
              <div className="space-y-8">
                <div className="relative">
                  ...
                  {" "}
                  <input className="w-full bg-transparent border-0 border-b border-outline-variant/40 py-3 font-body-md focus:border-primary transition-all placeholder:text-on-surface-variant/30" placeholder="Your full name" type="text" />
                </div>
                {" "}
                <div className="relative">
                  <label className="block font-label-caps text-[10px] uppercase tracking-widest text-on-surface-variant mb-2">
                  ...
                  {" "}
                  <input className="w-full bg-transparent border-0 border-b border-outline-variant/40 py-3 font-body-md focus:border-primary transition-all placeholder:text-on-surface-variant/30" placeholder="Street address" type="text" />
                </div>
                {" "}
                <div className="grid grid-cols-2 gap-8">
                  <div className="relative">
                    ...
                    {" "}
                    <input className="w-full bg-transparent border-0 border-b border-outline-variant/40 py-3 font-body-md focus:border-primary transition-all placeholder:text-on-surface-variant/30" placeholder="e.g. Lagos" type="text" />
                  </div>
                  {" "}
                  <div className="relative">
                    <label className="block font-label-caps text-[10px] uppercase tracking-widest text-on-surface-variant mb-2">
                    ...
                    {" "}
                    <input className="w-full bg-transparent border-0 border-b border-outline-variant/40 py-3 font-body-md focus:border-primary transition-all placeholder:text-on-surface-variant/30" placeholder="Postal code" type="text" />
                  </div>
                </div>
              </div>
            </div>
            {/* Shipping */}
            <div>
              <h2 className="font-headline-lg-mobile text-headline-lg-mobile mb-6 text-on-surface">Delivery</h2>
              {" "}
              <div className="p-6 border border-outline-variant/30 rounded-lg bg-surface-container-low">
                <p className="font-label-caps text-label-caps uppercase text-primary tracking-[0.15em] mb-2">Quoted After Order</p>
                <p className="text-body-sm text-on-surface-variant">
                  Shipping from Lagos is same-week locally, 2-4 days nationwide, or DHL 3-7 days internationally. The
                  atelier confirms your exact rate once the order is placed.
                </p>
              </div>
            </div>
          ...
          <footer className="fixed bottom-0 left-0 w-full bg-surface-container-lowest/90 backdrop-blur-md p-6 border-t border-outline-variant/10 z-50">
            <div className="max-w-lg mx-auto space-y-4">
              <p className="text-[10px] text-center text-on-surface-variant px-4 leading-relaxed">
                ...
                and
                {" "}
                <Link className="underline" href="/shipping">Shipping & Returns</Link>
                .
              </p>
              {" "}
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 gap-x-6">
                  <div className="md:col-span-2 relative input-focus-effect">
                    ...
                    {" "}
                    <input className="w-full bg-transparent border-0 border-b border-outline-variant/50 focus:border-primary focus:ring-0 py-2 transition-all duration-300" placeholder="Your full name" type="text" />
                  </div>
                  {" "}
                  <div className="md:col-span-2 relative input-focus-effect">
                  ...
                  <div className="relative input-focus-effect">
                    ...
                    {" "}
                    <input className="w-full bg-transparent border-0 border-b border-outline-variant/50 focus:border-primary focus:ring-0 py-2 transition-all duration-300" placeholder="e.g. Lagos" type="text" />
                  </div>
                  {" "}
                  <div className="relative input-focus-effect">
                    <label className="block text-label-caps text-outline mb-2 uppercase tracking-widest">Postal Code</label>
                    {" "}
                    <input className="w-full bg-transparent border-0 border-b border-outline-variant/50 focus:border-primary focus:ring-0 py-2 transition-all duration-300" placeholder="Postal code" type="text" />
                  </div>
                </div>
              </section>
              {/* Section: Shipping */}
              <section>
                <h2 className="font-headline-lg text-headline-lg text-on-surface mb-8">Shipping</h2>
                {" "}
                <div className="p-6 bg-surface-container-low border border-outline-variant/30">
                  <p className="font-body-md font-semibold text-on-surface mb-2">Quoted After Order</p>
                  <p className="text-body-sm text-outline">
                    Same-week locally from Lagos, 2-4 days nationwide, or DHL 3-7 days internationally. The atelier
                    confirms your exact rate once the order is placed — see the summary at right.
                  </p>
                </div>
              </section>
              {/* Section: Payment */}
        ...
        <footer className="bg-surface-container-low dark:bg-surface-container-highest mt-24">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter px-margin-desktop py-section-padding max-w-container-max mx-auto">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a className="text-body-sm text-on-surface-variant hover:underline decoration-primary transition-all" href={site.socials.instagram.url} target="_blank" rel="noopener noreferrer">
                    Instagram
                  </a>
                </li>
                {" "}
                <li>
                  <a className="text-body-sm text-on-surface-variant hover:underline decoration-primary transition-all" href={site.socials.tiktok.url} target="_blank" rel="noopener noreferrer">
                    TikTok
                  </a>
                </li>
                {" "}
                <li>
                  <a className="text-body-sm text-on-surface-variant hover:underline decoration-primary transition-all" href={whatsappLink()} target="_blank" rel="noopener noreferrer">
                    WhatsApp
                  </a>
                </li>
              </ul>
